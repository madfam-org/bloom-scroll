...
- ~~**🟠 H9: OpenAPI docs exposed in production**~~ — Fixed 2026-05-28: production disables `/docs`, `/redoc`, and `/openapi.json`; `scripts/prod-smoke.sh` verifies the public API stays closed.
